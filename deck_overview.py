    ...
    <div class='row '>
        ...
        <div class='col col-sm-12 col-lg-6 text-center'>
            ...
            <div class='row'>
                ...
                <div class= 'col col-sm-6 widget widget-top' title='Gesamtanzahl aller Karten/Notizen in diesem Deck' style="background-color:{OVERVIEW[total-notes-wedgit-bg]} ">
                    <span class='number'> {cards[total]:d}<br> </span>  {LOCALS[Total]} {cards[count_label]}
                </div>

                <div class= 'col col-sm-6 widget widget-top' title='Geschätzter Zeitpunkt bis alle heute fälligen Karten erledigt sind' style="background-color: {OVERVIEW[remaining-wedgit-bg]} ">
            ...
            <div class='row'>
                <div class='widget  col col-sm-6 d-flex align-items-center justify-content-center' title='Neue Karten, die heute eingeführt werden können' style="background-color:{OVERVIEW[new-wedgit-bg]}  ">
                    <div>
                    <div class='number'>
                        {cards[new]:d}
                    </div>
                ...
                <div class='widget  col col-sm-6 d-flex align-items-center justify-content-center' title='Karten im Lernstatus mit kurzen Intervallen' style="background-color:{OVERVIEW[learning-wedgit-bg]}">
                    <div>
            ...
            <div class='row'>
                ...
                <div class='widget  col col-sm-6 d-flex align-items-center justify-content-center' title='Wiederholungskarten, die heute fällig sind' style="background-color: {OVERVIEW[review-wedgit-bg]} ">
                        <div>
                        <div class='number'>
                            {cards[review]:d}
                        </div>
                ...
                <div class='widget  col col-sm-6 d-flex align-items-center justify-content-center' title='Summe aus neuen, Lern- und Wiederholungskarten für heute' style="background-color: {OVERVIEW[total-wedgit-bg]}  ">
                    <div>
                    <div class='number'>
                            {cards[todo]:d}
                    </div>
