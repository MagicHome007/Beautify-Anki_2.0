...
Wenn Anki beim Import meldet **"Invalid add-on manifest"**, fehlt meist eine gültige `manifest.json` in der Paketdatei oder die Paketstruktur ist falsch.

Erzeuge die Installationsdatei so:
